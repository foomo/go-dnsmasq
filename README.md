...
[release]: https://github.com/foomo/go-dnsmasq/releases
...
Download the binary for your OS from the [releases page](https://github.com/foomo/go-dnsmasq/releases/latest).    
